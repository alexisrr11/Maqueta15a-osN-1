let tiempoRestante = 10;
        ...
        function actualizarCuentaRegresiva() {
            if (tiempoRestante > 0) {
                ...
                document.querySelector(".cuenta-regresiva").innerHTML = "<h4>¡Felices 15 Años Zoe!</h4><br><h4>¡El gran día ha llegado!</h4>";
            }
        }
        ...
        musicIcon.addEventListener("click", function () {
            if (music.paused) {
                music.play();
                musicIcon.style.color = "rgb(216, 112, 147)";
                musicIcon.style.border = "3px solid rgb(216, 112, 147)";
            } else {
                music.pause();
                music.currentTime = 0;
                musicIcon.style.color = "rgba(216, 112, 147, 0.336)";
                musicIcon.style.border = "3px solid rgba(216, 112, 147, 0.336)";
            }
        });
